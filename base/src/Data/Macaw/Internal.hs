...
-- | Items in this module should /not/ be considered part of macaw-base's
-- API, they are exported only for the sake of the test suite.
module Data.Macaw.Internal
  ( assertionsEnabled
  ) where
...
-- pass the correct flags to GHC for the @lib:macaw-base@ target. We verify
