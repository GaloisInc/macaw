  ...
  TT.defaultMainWithIngredients ingredients $
    TT.testGroup "macaw-x86-symbolic tests"
      [ TT.testGroup "Unit tests" 
          ...
          , TTH.testCase "st0" $ getRegName MXSR.st0 TTH.@?= "r!stmm0"
          , TTH.testCase "st1" $ getRegName MXSR.st1 TTH.@?= "r!stmm1"
          , TTH.testCase "st2" $ getRegName MXSR.st2 TTH.@?= "r!stmm2"
          , TTH.testCase "st3" $ getRegName MXSR.st3 TTH.@?= "r!stmm3"
          , TTH.testCase "st4" $ getRegName MXSR.st4 TTH.@?= "r!stmm4"
          , TTH.testCase "st5" $ getRegName MXSR.st5 TTH.@?= "r!stmm5"
          , TTH.testCase "st6" $ getRegName MXSR.st6 TTH.@?= "r!stmm6"
          , TTH.testCase "st7" $ getRegName MXSR.st7 TTH.@?= "r!stmm7"
